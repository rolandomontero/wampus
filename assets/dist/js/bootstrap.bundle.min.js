...
window.addEventListener("scroll", function() {
    // Selecciona el elemento con la clase .bg-dark
    const f = 200;
    const o = 0.7;

    var element = document.querySelector('.bg-dark');
    element.style.setProperty('--bs-bg-opacity', ((window.scrollY / f) < o) ? window.scrollY / f : (window.scrollY < f) ? o : o);
    console.log(window.scrollY);
});
document.querySelectorAll('.tooltip-wp')
    .forEach(tooltip => {
